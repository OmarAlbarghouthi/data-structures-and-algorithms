...
const addTwo = (arr) => {
  // Solution code here...
  let Array = [];
  for (let i = 0; i < arr.length; i++) { Array.push(arr[i] + 2); }
  return Array;
};
...
const typeNum = (arr) => {
  // Solution code here...
  let Array = arr.filter(item => typeof item === 'number' ? true : false);
  return Array;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let Array = arr.filter(item => item.includes('and') ? true : false);
  return Array;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let Array = arr.filter(item => item % 2 != 0 ? true : false);
  return Array;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let Array = arr.filter(item => !forbiddenValues.includes(item));
  return Array;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  let Array = arr.filter(item => item.baseStat > minBaseStat ? true : false);
  return Array;
};
...
const getStatName = (arr, minBaseStat) => {
  ...
  let Array = arr.filter(item => item.baseStat > minBaseStat ? true : false);
  let ArrayName = [];
  Array.forEach(element => ArrayName.push(element.stat.name));
  return ArrayName;
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  let Array = arr.filter(item => !item.children ? true : false);
  console.log(Array);
  return Array;
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  let Arr = arr.filter(item => typeof item === 'string' ? false : true);
  let Array  = Arr.map(item => item % 2 === 0 ? 'even' : 'odd');
  return Array ;
};
