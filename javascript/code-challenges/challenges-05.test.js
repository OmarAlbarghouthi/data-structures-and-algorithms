...
const toLastNames = people => {
  // Solution code here...
  let Array = people.map( item => `${item.firstName} ${item.lastName}`);
  return Array;
};
...
const addValues = (arr) => {
  // Solution code here...
  let Array = arr.reduce((idx, ele) => idx += ele, 0);
  return Array;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let Array = arr.reduce((idx, ele) => idx += ele.purchasePrice, 0);
  return Array;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let Array = arr.reduce(idx => idx += 1, 0);
  return Array;
};
...
const reversedString = (str) => {
  // Solution code here...
  let Array = str.split('').reduce((idx, ele) => ele + idx, '');
  return Array;
};
