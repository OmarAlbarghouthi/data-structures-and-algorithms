...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((A, B) => sortByDays[A.dayOfWeek.toLowerCase()] - sortByDays[B.dayOfWeek.toLowerCase()]);
  return arr;
...
const sortSchedule = (arr) => {
  ...
  arr.sort((A, B) => {
    if (A.dayOfWeek + A.start === B.dayOfWeek + B.start) {
      return A.end - B.end;
    }
      ...
      return sortByDays[A.dayOfWeek.toLowerCase()] - sortByDays[B.dayOfWeek.toLowerCase()];
    }
  });
  return arr;
